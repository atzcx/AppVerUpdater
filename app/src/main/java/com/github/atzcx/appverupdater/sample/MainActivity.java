...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnUpdateWithHeaders).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void update(){
        appVerUpdater = new AppVerUpdater()
                .setUpdateJSONUrl("https://my-json-server.typicode.com/cristianrp/AppVerUpdaterAPI/version/")
    ...
    private void updateWithHeaders(){

        /*
          You can send headers to your API, like an authentication token, username, etc.
         */
        Map<String, String> headers = new HashMap<>();
        headers.put("X-USER", "dev1");
        headers.put("X-TOKEN", "_Cg1xPsyP6qAyCKzjJN7");
        appVerUpdater = new AppVerUpdater()
                .setUpdateJSONUrl("https://my-json-server.typicode.com/cristianrp/AppVerUpdaterAPI/version/")
                .setHeaders(headers)
                .setShowNotUpdated(true)
                ...
                .setCallback(new Callback() {
                    ...
                    public void onFailure(UpdateErrors error) {
                        ...
                        if (error == UpdateErrors.NETWORK_NOT_AVAILABLE)
                            ...
                            Toast.makeText(MainActivity.this, "The file containing information about the updates are empty.", Toast.LENGTH_LONG).show();
                        else if (error == UpdateErrors.ERROR_UNAUTHORIZED)
                            Toast.makeText(MainActivity.this, "Authentication token expired.", Toast.LENGTH_LONG).show();
